...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Modification Producteur</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('producteur.update',Auth::user()->id) }}">
                        {{ csrf_field() }}
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" rows="5" cols="20" class="form-control @error('description') is-invalid @enderror" name="description" required autocomplete="description">{{ Auth::user()->description }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="numero" type="tel" minlength="10" maxlength="10"  class="form-control @error('numero') is-invalid @enderror" name="numero" value="{{ Auth::user()->numero }}" required autocomplete="numero">
